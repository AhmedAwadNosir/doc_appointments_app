...
class ErrorHandler implements Exception {
  late ApiErrorModal apiErrorModel;
...
ApiErrorModal _handleError(DioException error) {
  switch (error.type) {
    case DioExceptionType.connectionTimeout:
    ...
    case DioExceptionType.badResponse:
      if (error.response != null &&
        ...
        return ApiErrorModal.fromJson(error.response!.data);
      } else {
